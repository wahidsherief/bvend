                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info"
                                        href="{{route('vendor_account_locker_machine_show', [$transaction->vendor_id, $transaction->machine_model, $transaction->machine_id])}}">{{$transaction->machine_code}}</a>
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-secondary btn-sm"
                                        href="{{
                                        route('vendor_account_transaction_details', [$transaction->vendor_id, $transaction->id])}}">
                                        Details
                                    </a>
                                </td>
                            </tr>
