            ...
            <div class="col-md-6">
                ...
                <ul class="list-group list-group-small list-group-flush">
                    ...
                    <li class="list-group-item list-shrinked list-borderless d-flex px-3">
                        ...
                        <span
                            class="ml-auto text-right text-semibold text-reagent-gray">{{ $transaction->vendor->business_name }}</span>
                    </li>
                    <li class="list-group-item list-shrinked list-borderless d-flex px-3">
                        <span class="text-semibold text-fiord-blue">Vendor Name</span>
                        <span
                            class="ml-auto text-right text-semibold text-reagent-gray">{{ $transaction->vendor->name }}</span>
                    </li>
                    <li class="list-group-item list-shrinked list-borderless d-flex px-3">
                        <span class="text-semibold text-fiord-blue">Vendor Mobile</span>
                        <span
                            class="ml-auto text-right text-semibold text-reagent-gray">{{ $transaction->vendor->phone }}</span>
                    </li>
                    <li class="list-group-item list-shrinked list-borderless d-flex px-3">
