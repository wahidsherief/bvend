...
<li class="nav-item">
    <a class="nav-link font-weight-bold" href="{{route('vendor_account_machine', $vendor_id)}}">Machine</a>
</li>
<li class="nav-item">
...
<li class="nav-item ml-auto">
    <a class="btn btn-bvend" href="{{route('vendor_account_machine_create', $vendor_id)}}">Create Machine</a>
</li>
@endif