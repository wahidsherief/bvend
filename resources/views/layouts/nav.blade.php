            ...
            <ul class="navbar-nav border-left flex-row ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img style="width: 40px; height: 40px" class="user-avatar rounded-circle mr-2"
                            src="{{asset('uploads/vendors/'. auth()->user()->image)}}" alt="User Avatar" />
                        @else
                        <img style="width: 40px; height: 40px" class="user-avatar rounded-circle mr-2"
                            src="{{asset('img/logo.png')}}" alt="User Avatar" />
                        @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-small">
                        ...
                        <a class="dropdown-item" href="components-blog-posts.html">
                            <i class="material-icons">vertical_split</i> Blog
                            Posts</a>
                        <a class="dropdown-item" href="add-new-post.html">
                            <i class="material-icons">note_add</i> Add New Post</a>
                        <div class="dropdown-divider"></div> --}}
                        <a class="dropdown-item bg-white" href="{{ route('logout') }}" onclick="event.preventDefault();
