...
export default class AdminDashboard extends Component {
    ...
    componentDidMount() {
        ...
        let api_url = host + '/admin/dashboard/0';
    ...
    selectDate(e) {
        ...
        let api_url = host + '/admin/dashboard/' + date;
        ...
        return this.state.loading == false ? (
            <div>
                {this.state.ml_machines.length > 0 ? (
                                                                                    ...
                                                                                    <tr>
                                                                                        <td className="text-left">
                                                                                            <a
                                                                                                ...
                                                                                                href={`admin/vendor/${ml_8_machine.vendor_id}/machine/show/8/${ml_8_machine.id}`}
                                                                                            >
                                                                                                {
                                                                                ...
                                                                                (ml_32_machine) => (
                                                                                    <tr>
                                                                                        <td className="text-left">
                                                                                            <a
                                                                                                className="btn btn-xs btn-info"
                                                                                                href={`admin/vendor/${ml_32_machine.vendor_id}/machine/show/32/${ml_32_machine.id}`}
                                                                                            >
                                                                                                {
                    ...
                    <center>
                        <h5 class="font-weight-light font-italic">Bvend Admin Dashboard</h5>
                    </center>
                )}
            </div>
        ) : (
